...
async function renderAllMedicines() {
    ...
    container.innerHTML = `
        ...
        <div class="filters-bar"><select id="sortBy" class="sort-select"><option value="expiry_asc">${t('closest_expiry')}</option><option value="expiry_desc">${t('farthest_expiry')}</option><option value="name_asc">${t('name_asc')}</option><option value="name_desc">${t('name_desc')}</option><option value="date_desc">${t('newest_first')}</option></select><button id="addGeneralMedBtn" class="plus-icon-btn">${t('add_med')}</button><button id="batchAddToPharmacyBtn" class="plus-icon-btn" style="display:none;">${t('batch_add_to_pharmacy')}</button><button id="batchDeleteBtn" class="batch-delete-btn" style="display:none;">🗑️ ${t('batch_delete')}</button><button id="selectAllBtn" class="select-all-btn" style="display:none;">${t('select_all')}</button><button id="deselectAllBtn" class="deselect-all-btn" style="display:none;">${t('deselect_all')}</button></div>
...
async function renderPharmacyMedicines() {
    ...
    container.innerHTML = `
        <div class="search-container"><div class="search-wrapper"><input type="text" id="search" placeholder="${t('search_placeholder')}"><button class="search-btn">${t('search_btn')}</button><button id="barcodeSearchBtn" class="barcode-search-btn">📷 باركود</button></div><div id="suggestionsBox" class="suggestions-list"></div></div>
        <div class="filters-bar"><select id="sortBy" class="sort-select"><option value="expiry_asc">${t('closest_expiry')}</option><option value="expiry_desc">${t('farthest_expiry')}</option><option value="name_asc">${t('name_asc')}</option><option value="name_desc">${t('name_desc')}</option><option value="date_desc">${t('newest_first')}</option></select><button id="addMedBtn" class="plus-icon-btn">${t('add_med')}</button><button id="recycleBinBtn" class="recycle-bin-btn">🗑️ سلة المحذوفات</button><button id="batchDeleteBtn" class="batch-delete-btn" style="display:none;">🗑️ ${t('batch_delete')}</button><button id="selectAllBtn" class="select-all-btn" style="display:none;">${t('select_all')}</button><button id="deselectAllBtn" class="deselect-all-btn" style="display:none;">${t('deselect_all')}</button></div>
        <div class="content-list" id="contentList"></div><div id="stats"></div>
    `;
